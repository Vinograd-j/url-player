...
public:
    ...
    explicit Config(const std::vector<Button>& buttons, const tgui::Layout2d& music_list_size,
                    const tgui::Layout2d& music_list_position, const tgui::Layout2d& music_list_button_size)
                                                                                                         : _buttons(buttons),
